<nav class="navbar navbar-expand-md navbar-dark bg-dark px-5">
    <div class="container-fluid">
        <a class="navbar-brand" href="{{ route('book.index') }}"><img src="{{ asset('img/kobo-nobg.png') }}" alt="kobo"
                width="100px"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('book') ? 'active' : '' }}" aria-current="page"
                        href="{{ route('book.index') }}">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('book/create') ? 'active' : '' }}"
                        href="{{ route('book.create') }}">Create</a>
                </li>
                {{-- <li class="nav-item">
